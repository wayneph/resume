...
class Present extends BL
{
    ...
    public function __construct()
    {
        ...
        $entityData=parent::buildEntityInfo();
        $heading=$this->pageArray['information'][0]['entity'];
        ...
        $this->html=str_replace("###entitiesList###",$entityData,$this->html);
        $this->html=str_replace("##category##",$heading,$this->html);

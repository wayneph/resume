...
SELECT * FROM pages  WHERE site_id=8 ORDER BY seq;      ##tsc
SELECT * FROM pages  WHERE site_id=9 ORDER BY seq;      ##tek
## by slug
SELECT * FROM pages  WHERE slug='index';                ##index

SELECT * FROM page_elements WHERE (page_id = 24 AND status = 1) ORDER BY seq

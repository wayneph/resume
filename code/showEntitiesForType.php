...
class Present extends BL
{
    ...
    public function __construct()
    {
        ...
        $entitiesList=parent::buildShowEntitiesForType();
        ...
        $this->html=str_replace("###entitiesList###",$entitiesList,$this->html);
        $this->html=str_replace("##category##",$headingBit,$this->html);
